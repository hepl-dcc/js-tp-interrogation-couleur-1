/*
INTERRO : Colorie la page
Ta mission est : au clic sur un des boutons, colorie la page dans la couleur choisie par l'utilisateur.
Cachier des charges :
	- tu vas appliquer le style avec CSS, JavaScript va se contenter d'ajouter au clic,
    une classe sur le body qui indiquera à CSS dans quelle couleur il doit être stylé ;
